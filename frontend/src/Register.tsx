    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Box sx={{ width: '100%', maxWidth: '440px', margin: '0 auto' }}>
          ...
          <Typography variant="h3" sx={{ fontWeight: 800, mb: 1, letterSpacing: '-1.5px', color: '#111827', fontSize: '2.8rem' }}>Create Account!</Typography>
      ...
      <Box sx={{
        flex: 1,
        backgroundImage: 'url(https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80)',
        ...
        <Box sx={{ position: 'relative', zIndex: 1, maxWidth: '600px' }}>
          <Typography variant="h4" sx={{ 
            ...
            Start managing your projects and teams securely with Plannex.
          </Typography>
        </Box>
      </Box>
    </Box>
